...
public class ArmorTank extends EnemyTank {
        ...
        protected void loadImages() {
                images[Direction.UP.ordinal()][0] = new ImageIcon("src/main/resources/images/tank_armor_up_c0_t1.png")
                                .getImage();
                images[Direction.UP.ordinal()][1] = new ImageIcon("src/main/resources/images/tank_armor_up_c0_t2.png")
                                .getImage();

                images[Direction.DOWN.ordinal()][0] = new ImageIcon(
                                "src/main/resources/images/tank_armor_down_c0_t1.png").getImage();
                images[Direction.DOWN.ordinal()][1] = new ImageIcon(
                                "src/main/resources/images/tank_armor_down_c0_t2.png").getImage();

                images[Direction.LEFT.ordinal()][0] = new ImageIcon(
                                "src/main/resources/images/tank_armor_left_c0_t1.png").getImage();
                images[Direction.LEFT.ordinal()][1] = new ImageIcon(
                                "src/main/resources/images/tank_armor_left_c0_t2.png").getImage();

                images[Direction.RIGHT.ordinal()][0] = new ImageIcon(
                                "src/main/resources/images/tank_armor_right_c0_t1.png").getImage();
                images[Direction.RIGHT.ordinal()][1] = new ImageIcon(
                                "src/main/resources/images/tank_armor_right_c0_t2.png").getImage();
        }
